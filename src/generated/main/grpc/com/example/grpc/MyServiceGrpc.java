...
public final class MyServiceGrpc {
  ...
  public static final String SERVICE_NAME = "example.MyService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.example.grpc.Request,
      com.example.grpc.Response> getSendMessageMethod;
  ...
  public static io.grpc.MethodDescriptor<com.example.grpc.Request,
      com.example.grpc.Response> getSendMessageMethod() {
    io.grpc.MethodDescriptor<com.example.grpc.Request, com.example.grpc.Response> getSendMessageMethod;
    if ((getSendMessageMethod = MyServiceGrpc.getSendMessageMethod) == null) {
      synchronized (MyServiceGrpc.class) {
        if ((getSendMessageMethod = MyServiceGrpc.getSendMessageMethod) == null) {
          MyServiceGrpc.getSendMessageMethod = getSendMessageMethod =
              ...
              .setSchemaDescriptor(new MyServiceMethodDescriptorSupplier("sendMessage"))
              .build();
        }
      }
    }
  ...
  public static abstract class MyServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sendMessage(com.example.grpc.Request request,
  ...
  public static final class MyServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.Response sendMessage(com.example.grpc.Request request) {
  ...
  public static final class MyServiceFutureStub extends io.grpc.stub.AbstractFutureStub<MyServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.Response> sendMessage(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND_MESSAGE:
          serviceImpl.sendMessage((com.example.grpc.Request) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.Response>) responseObserver);
          break;
        default:
  ...
  private static abstract class MyServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.Messages.getDescriptor();
    }
